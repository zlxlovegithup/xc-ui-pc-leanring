...
<script>
  ...
  export default {
      ...
      study(chapter){
        ...
        courseApi.get_media(this.courseId,chapter).then((res)=>{
          ...
          if(res.success){
            ...
            // 例如: http://video.xuecheng.com/video/c/5/c5c75d70f382e6016d2f506d134eee11/hls/c5c75d70f382e6016d2f506d134eee11.m3u8
    ...
    created(){
      ...
      //课程id 获取路由中的courseId 例如: http://ucenter.xuecheng.com/learning/course/getmedia/{courseId}/{teachplanId} -->courseId
      this.courseId = this.$route.params.courseId
      //章节id 获取路由中的章节id  例如: http://ucenter.xuecheng.com/learning/course/getmedia/{courseId}/{teachplanId} -->teachplanId
      this.chapter = this.$route.params.chapter
      //取出课程Id  根据课程id查询课程信息
      systemApi.course_view(this.courseId).then((view_course)=>{
          console.log("========view_course:"+view_course);
          ...
          if(courseInfo.teachplan){
            ...
            console.log("========this.teachplanList:"+this.teachplanList);
            //如果第二个参数没有之让其默认为第一个
